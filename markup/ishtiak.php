...
<body>
    ...
    <nav class="bg-gray-200 py-4 px-4">
        <ul
            ...
            <li><a href="" class="after-effect relative hover:text-green-500 duration-500">Home</a>
            </li>
            ...
            <li class="group">
                ...
                <!-- Mega Menu Dropdown -->
                <div id="mega-menu"
                    class="bg-gray-100 absolute -left-4 top-4 w-screen shadow-md py-8 opacity-0 pointer-events-none ease-in-out flex justify-center transition-all duration-500 z-10">
    ...
    <footer class="bg-black py-8 md:py-50 ">
        <div class="holder">
            <div class="md:hidden border-b-2 border-white text-white pb-10 space-y-4">
                ...
                <a href=""
                    class="text-xl hover:text-green-500 duration-500 flex justify-between items-center gap-10 group">News
                    & Alerts
                    <span>
                        <svg xmlns="http://www.w3.org/2000/svg" width="43" height="11" viewBox="0 0 43 11" fill="none">
                            <path fill-rule="evenodd" clip-rule="evenodd"
                ...
                <a href=""
                    class="text-xl hover:text-green-500 duration-500 flex justify-between items-center gap-10 group">Contact
                    Us
                    <span>
                        <svg xmlns="http://www.w3.org/2000/svg" width="43" height="11" viewBox="0 0 43 11" fill="none">
                            <path fill-rule="evenodd" clip-rule="evenodd"
            ...
            <div class="hidden md:flex justify-between items-center gap-10 border-b border-white text-white pb-10">
                <a href="" class="hover:text-green-500 duration-500 after-effect relative after:bg-white">About</a>
                <a href="" class="hover:text-green-500 duration-500 after-effect relative after:bg-white">I have been
                    scam</a>
                <a href="" class="hover:text-green-500 duration-500 after-effect relative after:bg-white">Protection
                    against Scam </a>
                <a href="" class="hover:text-green-500 duration-500 after-effect relative after:bg-white">Type of scam
                </a>
                <a href="" class="hover:text-green-500 duration-500 after-effect relative after:bg-white">News & Alerts
                </a>
                <a href="" class="hover:text-green-500 duration-500 after-effect relative after:bg-white">Contact Us
                </a>
            </div>
            ...
            <div
                ...
                <div class="space-x-4 md:[&>*]:text-base [&>*]:text-xs font-medium">
                    <span>Site designed by <a href=""
                            class="hover:text-green-500 duration-500 after-effect relative after:bg-white">
                            Skylark</a></span>
                    <a href="" class="hover:text-green-500 duration-500 after-effect relative after:bg-white">Legal</a>
                    <a href="" class="hover:text-green-500 duration-500 after-effect relative after:bg-white">Cookie
                        Policy</a>
                    <a href="" class="hover:text-green-500 duration-500 after-effect relative after:bg-white">Privacy
                        Policy</a>
                </div>
            </div>
        </div>
