<div class="swiper-slide">
    <a href="<?php the_permalink(); ?>" class="h-[350px] flex flex-wrap flex-col justify-end p-5  group overflow-hidden ">
        ...
        <div class="<?php ksa("relative z-20 [&>*]:text-white [&>*]:font-light  max-h-0 overflow-hidden group-hover:max-h-[200px] transition-all duration-500 max-w-56"); ?>">
            <?php the_excerpt(); ?>
        </div>
