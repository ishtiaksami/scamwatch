<div class="swiper-slide">
    <a href="<?php the_permalink(); ?>" class="h-[341px] flex flex-wrap flex-col justify-end p-5 relative group overflow-hidden before:absolute before:w-full before:h-full before:top-0 before:left-0 before:z-10 group hover:before:bg-black/50 before:transition-all">
